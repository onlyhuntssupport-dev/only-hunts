...
const navLinks = [
  ...
  // FIX: Replaced '#' with unique paths so React keys do not collide
  { href: '/dashboard/hunts', label: 'Manage Hunts', icon: Package },
  { href: '/dashboard/outfitters', label: 'Outfitters', icon: Users },
];
